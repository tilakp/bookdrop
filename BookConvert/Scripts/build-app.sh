#!/bin/bash
# Assembles BookConvert.app from the SwiftPM executable + Resources/Info.plist +
...
APP_DIR="$ROOT_DIR/.build/$CONFIG/BookConvert.app"
...
cp "$ROOT_DIR/.build/$CONFIG/BookConvert" "$APP_DIR/Contents/MacOS/BookConvert"
